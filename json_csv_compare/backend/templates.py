...
do not change type of data and do not add decimals
"""
...
human_template_change_output_format = """show the following in a list format with bullet points  {changed_lines}
like
1.
2.
3.
